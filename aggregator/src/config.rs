...
impl<'de> Deserialize<'de> for JobDriverConfig {
    fn deserialize<D: Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        let http_request_connection_timeout_secs = inner
            ...
            .unwrap_or_else(JobDriverConfig::default_http_connection_timeout_secs);
        let http_request_timeout_secs = inner
            .http_request_timeout_secs
            .unwrap_or_else(JobDriverConfig::default_http_request_timeout_secs);
        Ok(Self {
            job_discovery_interval_secs,
            ...
            http_request_connection_timeout_secs,
            http_request_timeout_secs,
            retry_initial_interval_millis: inner.retry_initial_interval_millis,
            retry_max_interval_millis: inner.retry_max_interval_millis,
            retry_max_elapsed_time_millis: inner.retry_max_elapsed_time_millis,
        })
    }
}

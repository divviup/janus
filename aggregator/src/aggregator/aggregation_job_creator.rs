...
#[cfg(test)]
mod tests {
    use crate::aggregator::test_util::ClockExt;
    ...
    async fn create_aggregation_jobs_for_time_interval_task() {
        ...
        let first_report_time = clock.now_at_batch_interval_start(task.time_precision());
    ...
    async fn create_aggregation_jobs_for_time_interval_task_not_enough_reports() {
        ...
        let report_time = clock.now_at_batch_interval_start(task.time_precision());

...
#[derive(Clone)]
pub struct WritableReportAggregation<const SEED_SIZE: usize, A: BoundedAggregator<SEED_SIZE>> {
...
#[async_trait]
pub trait ReportAggregationUpdate<const SEED_SIZE: usize, A: BoundedAggregator<SEED_SIZE>>:
    Clone + Send + Sync
{

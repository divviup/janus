...
#[derive(Clone, Derivative, PartialEq, Eq)]
#[derivative(Debug)]
pub struct CommonTaskParameters {
...
impl AggregatorTask {
    ...
    pub fn new_with_common_parameters<I: IntoIterator<Item = HpkeKeypair>>(
        common_parameters: CommonTaskParameters,
        peer_aggregator_endpoint: Url,
        hpke_keys: I,
        aggregator_parameters: AggregatorTaskParameters,
...
impl TryFrom<SerializedTask> for AggregatorTask {
    type Error = Error;
...
pub mod test_util {
    ...
    impl TaskBuilder {
        ...
        pub fn with_id(self, task_id: TaskId) -> Self {
            Self(Task {
                common_parameters: super::CommonTaskParameters {
                    task_id,
